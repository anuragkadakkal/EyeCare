...
<!-- Mirrored from azim.commonsupport.com/Optcare/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2022 04:04:19 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

<title>Optcare - HTML 5 Template Preview</title>
    ...
    <div class="boxed_wrapper">
            ...
            <div class="popup-inner">
                ...
                <div class="auto-container">
                    <div class="search-form">
                        <form method="post" action="http://azim.commonsupport.com/Optcare/index.html">
                ...
                <div class="auto-container">
                    <div class="outer-box">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="index-2.html">Treatments</a>
                                            <ul>
                                        ...
                                        <li class="current dropdown"><a href="index-2.html">Pages</a>
                                            <ul>
                                                <li class="dropdown"><a href="index-2.html">Doctors</a>
                                                    <ul>
                                                ...
                                                <li class="dropdown"><a href="index-2.html">Shop</a>
                                                    <ul>
                        ...
                        <div class="nav-right">
                            ...
                            <div class="btn-box">
                                <a href="index-2.html" class="theme-btn btn-one">Appointment</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-12 col-md-12 offset-xl-7 cart-column">
                            <div class="total-cart-box clearfix">
                                ...
                                <a href="cart.html" class="theme-btn btn-one">Proceed to Checkout <i class="icon-74"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 form-column">
                        <div class="form-inner ml_30 mt_5">
                            <form action="http://azim.commonsupport.com/Optcare/index-3.html" method="post">
                                <div class="form-group">
        ...
        <footer class="main-footer p_relative">
                ...
                <div class="auto-container">
                    <div class="top-inner">
                        ...
                        <div class="footer-logo">
                            <figure class="logo"><a href="index-2.html"><img src="assets/images/footer-logo.png" alt=""></a></figure>
                        </div>
                        <ul class="footer-menu">
            ...
            <div class="footer-bottom centred">
                <div class="auto-container">
                    <div class="copyright"><p><a href="index-2.html">Optcare</a> &copy; 2022 All Right Reserved</p></div>
                </div>
            </div>
        </footer>
        <!-- main-footer end -->
...
<!-- Mirrored from azim.commonsupport.com/Optcare/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2022 04:04:20 GMT -->
</html>
