<?php
  ...
  $lkey=$_COOKIE["lkey"];
  //echo $lkey;
  $sql="select * from tb_staff where loginid='".$lkey."'";
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="index.php"><i class="fas fa-bars text-success"><span class=" font-weight-light text-success">&nbsp;&nbsp;Welcome <?php echo $fullname; ?></span>
          </i></a>
      </li>
      ...
      <!-- Sidebar Menu -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <!--  <li class="nav-item">
          ...
          <li class="nav-item">
            <a  href="viewdrs.php" class="nav-link ">
           ...
           <li class="nav-item">
            <a  href="viewpts.php" class="nav-link ">
          ...
          <i>General</i>
		  		...
		  		<li class="nav-item">
            <a  href="updatestaff.php" class="nav-link ">
